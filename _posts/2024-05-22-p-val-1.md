...
---
## 머리말
널리 사용되는 null hypothesis statistical testing<sup>영가설 통계 검정</sup>은 학부 1학년 수준 통계학에서 배울 정도로 널리 사용되는 가설 검정법이에요. 이는 Fisher의 test of significance와 Neyman-Pearson의 statistical hypothesis testing의 여러 요소가 뒤섞여 사용되고 있는데, 한번 자세히 알아봅시다.
<!--more-->
