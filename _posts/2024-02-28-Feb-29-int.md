...
For those who are not familiar with CSS which is a style sheet language, [CSS MDN WebDocs](https://developer.mozilla.org/en-US/docs/Web/CSS) may be helpful to understand the basics of CSS.
